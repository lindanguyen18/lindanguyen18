...
CREATE TABLE EMPLOYEE (
  EMP_NUM       VARCHAR(3),
  EMP_LNAME     VARCHAR(15)	NOT NULL, 			/* NOT NULL REQUIRES THAT A VALUE BE ENTERED */ 
  EMP_FNAME     VARCHAR(15)	NOT NULL,
  EMP_INITIAL   VARCHAR(1),  /* NOT NULL, */    /* NOTICE BELOW THAT EMP_NUM 106 HAS A NULL INITIAL. PLACE NOT NULL BETWEEN THE DATA TYPE AND , */ 
